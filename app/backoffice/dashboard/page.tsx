...
export default function Dashboard() {
    ...
    const fetchDataSumPerDayInYearAndMonth = async () => {
        try {
            ...
            const res = await api.post(`${config.apiServer}/api/report/sumPerDayInYearAndMonth`, payload);
    ...
    const fetchDataSumPerMonthInYear = async () => {
        try {
            ...
            const res = await api.post(`${config.apiServer}/api/report/sumPerMonthInYear`, payload);

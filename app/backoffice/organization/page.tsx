...
const OrganizationPage = () => {
    ...
    const fetchData = async () => {
        const res = await api.get(`${config.apiServer}/api/organization/info`);
    ...
    const save = async () => {
        try {
            ...
            await api.post(`${config.apiServer}/api/organization/create`, payload)
            Swal.fire({
                title: 'success',
                icon: 'success',
    ...
    const uploadFile = async () => {
        ...
        const response = await api.post(`${config.apiServer}/api/organization/upload`, formData)

...
export default function Page() {
    ...
    const getFoods = async () => {
        try {
            const res = await api.get(config.apiServer + '/api/food/list');
    ...
    const filterFoods = async (foodType: string) => {
        try {
            const res = await api.get(config.apiServer + '/api/food/filter/' + foodType);
            setFoods(res.data.results);
        } catch (e: any) {
            Swal.fire({
                title: 'error',
    ...
    const sale = async (foodId: number) => {
        try {
            ...
            await api.post(config.apiServer + '/api/saleTemp/create', payload);
            fetchDataSaleTemp();
        } catch (e: any) {
            Swal.fire({
                title: 'error',
    ...
    const fetchDataSaleTemp = async () => {
        try {
            const res = await api.get(config.apiServer + '/api/saleTemp/list');
    ...
    const removeSaleTemp = async (id: number) => {
        try {
            ...
            if (button.isConfirmed) {
                await api.delete(config.apiServer + '/api/saleTemp/remove/' + id);
                fetchDataSaleTemp();
            }
        } catch (e: any) {
            Swal.fire({
    ...
    const removeAllSaleTemp = async () => {
        try {
            ...
            if (button.isConfirmed) {
                ...
                await api.delete(config.apiServer + '/api/saleTemp/removeAll', { data: payload });
                fetchDataSaleTemp();
            }
        } catch (e: any) {
            Swal.fire({
    ...
    const updateQty = async (id: number, qty: number) => {
        try {
            ...
            await api.put(config.apiServer + '/api/saleTemp/updateQty', payload);
            fetchDataSaleTemp();
        } catch (e: any) {
            Swal.fire({
                title: 'error',
    ...
    const genereateSaleTempDetail = async (saleTempId: number) => {
        try {
            ...
            await api.post(config.apiServer + '/api/saleTemp/generateSaleTempDetail', payload);
    ...
    const fetchDataSaleTempInfo = async (saleTempId: number) => {
        try {
            const res = await api.get(config.apiServer + '/api/saleTemp/info/' + saleTempId);
    ...
    const selectTaste = async (tasteId: number, saleTempDetailId: number, saleTempId: number) => {
        try {
            ...
            await api.put(config.apiServer + '/api/saleTemp/selectTaste', payload);
            fetchDataSaleTempInfo(saleTempId);
        } catch (e: any) {
            Swal.fire({
                title: 'error',
    ...
    const unSelectTaste = async (saleTempDetailId: number, saleTempId: number) => {
        try {
            ...
            await api.put(config.apiServer + '/api/saleTemp/unSelectTaste', payload);
            fetchDataSaleTempInfo(saleTempId);
        } catch (e: any) {
            Swal.fire({
                title: 'error',
    ...
    const selectSize = async (sizeId: number, saleTempDetailId: number, saleTempId: number) => {
        try {
            ...
            await api.put(config.apiServer + '/api/saleTemp/selectSize', payload);
    ...
    const unSelectSize = async (saleTempDetailId: number, saleTempId: number) => {
        try {
            ...
            await api.put(config.apiServer + '/api/saleTemp/unSelectSize', payload);
            await fetchDataSaleTempInfo(saleTempId);
            await fetchDataSaleTemp();
        } catch (e: any) {
            Swal.fire({
    ...
    const createSaleTempDetail = async () => {
        try {
            ...
            await api.post(config.apiServer + '/api/saleTemp/createSaleTempDetail', payload);
            await fetchDataSaleTemp();
            await fetchDataSaleTempInfo(saleTempId);
        } catch (e: any) {
            Swal.fire({
    ...
    const removeSaleTempDetail = async (saleTempDetailId: number) => {
        try {
            ...
            await api.delete(config.apiServer + '/api/saleTemp/removeSaleTempDetail', { data: payload });
            await fetchDataSaleTemp();
            fetchDataSaleTempInfo(saleTempId);
        } catch (e: any) {
            Swal.fire({
    ...
    const printBillBeforePay = async () => {
        try {
            ...
            const res = await api.post(config.apiServer + '/api/saleTemp/printBillBeforePay', payload);
            setTimeout(() => {
    ...
    const endSale = async () => {
        try {
            ...
            if (button.isConfirmed) {
                ...
                await api.post(config.apiServer + '/api/saleTemp/endSale', payload);
                fetchDataSaleTemp();
    ...
    const printBillAfterPay = async () => {
        try {
            ...
            const res = await api.post(config.apiServer + '/api/saleTemp/printBillAfterPay', payload);
